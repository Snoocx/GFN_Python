...
#Der eingegebene Wert soll in Zentimeter umgerechnet und ausgegeben werden. 
#Das Programm soll nach der Eingabe des Werts 0 beendet werden.

#Hinweis:
#Bei einer while-Schleife wird immer angegeben, gemäß welcher Bedingung
#wiederholt werden soll, und nicht, gemäß welcher Bedingung beendet werden soll.
...
# Für die Übersicht teile ich die Zuweisung auf.. es geht auch so:
